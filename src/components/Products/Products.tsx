...
const nombreCategoria = (p: Producto) => p.categoria?.nombre ?? p.categoria;
...
function Products({ categoria }: Props) {
    ...
    const subcategoriasDeCategoria = (nombre: string) => {
    ...
    const seleccionarSubcategoria = (sub: string | null) => {
        setSubcategoria(sub);
            ...
            <div className="products-layout">
                <aside className="products-sidebar">
                    ...
                    {categorias.map((c) => {
                        ...
                        return (
                            <div className="sidebar-grupo" key={c.id_categoria}>
                                <Link
